...
function goView(idx)
{
	location.href="/manual/board_view.php?idx="+idx+"&board="+board;
}
</script>
...
<div class="table_list family_list">
	<div class="inner">
		...
		<div class="board_search p010">
			<form id="productForm" name="productForm" method="get" action="board.php">
		...
		<div class="main_table family_table p010">
			...
			{
			    ?><a href="/manual/board_write.php?board=<?php echo $_REQUEST['board']?>" class="writ-btn">글쓰기</a><?php 
			}
			?>
		</div>
