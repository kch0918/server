...
?>
    <div class="mypage-div">
    	<div class="myp-grid">
    		...
    		<div class="myp-rec">
    			귀사의 사이트는 <span class="rec-span">기업 사이트, 브랜드 사이트</span>로 <span class="rec-span"><?php echo $user_row['server_name']?> NAS 서버</span> 사용을 추천드립니다.
    		</div>
    	</div>
    </div>
    ...
    <div class="mypage-div">
        	...
        	<div class="myp-grid">
        		<p class="myp-tit">나이키 사의 추천 서버 안내<?php echo $server_info_row['server_type']?></p>
        		...
        		<div class="myp-payment">
        			...
        			<div class="payment-final">
        				...
        				<form name="payForm" method="post" action="/api_test_code/payResult_utf.php"><br>
        					<input type="text" id="goodsname" name="GoodsName" value="<?php echo($goodsName)?>"><br>
        					<input type="text" id="Amt" name="Amt" value="<?php echo($price)?>"><br>
        					<input type="text" id="mid" name="MID" value="<?php echo($MID)?>"><br>
        					<input type="text" id="moid" name="Moid" value="<?php echo($moid)?>"><br>
        					<input type="text" id="buyername" name="BuyerName" value="<?php echo($buyerName)?>"><br>
        					<input type="text" id="buyeremail" name="BuyerEmail" value="<?php echo($buyerEmail)?>"><br>
        					<input type="text" id="buyertel" name="BuyerTel" value="<?php echo($buyerTel)?>"><br>
        					<input type="text" id="returnurl" name="ReturnURL" value="<?php echo($returnURL)?>"><br>
        					<input type="text" name="VbankExpDate" value=""><br>
        					<input type="text" name="GoodsCl" value="1"/><br>
        					<input type="text" name="TransType" value="0"/><br>
        					<input type="text" name="CharSet" value="utf-8"/><br>
        					<input type="text" name="ReqReserved" value=""/><br>
        					<input type="text" id="edidate" name="EdiDate" value="<?php echo($ediDate)?>"/><br>
        					<input type="text"  id="signdata" name="SignData" value="<?php echo($hashString)?>"/>
        				</form>
        			</div>
        			<!-- // payment_final -->
