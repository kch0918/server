        		...
        		<div class="myp-payment">
        			...
        			<div class="cell cell2">
        				...
        				<ul>
        					<li>
        						<p class="myp-rchk on">
        							<input id="mypService1" type="radio" class='mypservice' name="rchk1" value="" onclick="price_choose(this);">
        					...
        					<li>
        						<p class="myp-rchk">
        							<input id="mypService2" type="radio" class='mypservice' name="rchk1" value="" onclick="price_choose(this);">
        					...
        					<li>
        						<p class="myp-rchk">
        							<input id="mypService3" type="radio" class='mypservice' name="rchk1" value="" onclick="price_choose(this);">
        			...
        			<div class="payment-final">
        				...
        				<div class="cell cell2">
        					<button id="finalBtn" onclick="show_invoice();">세금 계산서 작성</button>
        				</div>
