		...
		<div class="inner">
        	...
        	<div class="agree-cont">
        		<div class="joine-div">
        			...
        			<p class="color-g joine-tit">아이디 찾기 신청이 완료되었습니다.</p>
        			<p class="joine-stit">입력하신 이메일 주소로 메일이 발송되오니, <br>확인후 이용해 주시기 바랍니다.</p>
        			<div><a href="./login.php" class="login-btn">로그인 페이지</a><a href="./find_pw_view.php" class="login-btn">비밀번호 찾기</a></div>
        		</div>
        	</div>		
		</div>
	</div>
