...
<div class="result">
	...
	//발주 : FK906201207001
	//-------------------------------------------
	$FormKey = 'FK901201207001';

	$EDocInvoiceType = '1';					//1-거래명세서, 2-입금표, 3-청구서, 4-견적서, 5-영수증, 6-발주서

	$WriteDate = '';						//작성일자 (YYYYMMDD), 공백입력 시 Today로 작성됨.

	$CertYN = False;						//발행 시 공인인증서 확서인 여부
	...
	$EDoc = array(
		...
		'EDocInvoiceType'	=> $EDocInvoiceType,
		'CertYN'			=> $CertYN,
	...
	$Result = $BaroService_EDOC->RegistEDoc(array(
		'CERTKEY'		=> $CERTKEY,
